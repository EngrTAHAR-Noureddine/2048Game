                            ...
                            GestureDetector(
                              ...
                              onHorizontalDragEnd: (DragEndDetails d) {
                                ...
                                if (d.primaryVelocity! > 0) {
                                  GameController().oldBoard = store.state.movementState.board;
                                  ...
                                  Container(
                                    ...
                                    child: Center(
                                      child:  Column(
                                        ...
                                        children: [
                                          const Text('Game Over' ,style: TextStyle(color: headerColor,fontSize: 48 , fontWeight: FontWeight.bold), ),
                                          Text('${GameController().scoreGame}' ,style: const TextStyle(color: headerColor,fontSize: 48 , fontWeight: FontWeight.bold), ),
                                        ],
                                      ),
                                    ),
                                  ):
  ...
  Widget _header(dynamic store){
    return Container(
      ...
      child:  Column(
        ...
        children:  [
          const Text('2048 Game' ,style: TextStyle(color: headerColor,fontSize: 48 , fontWeight: FontWeight.bold), ),
          ...
          Row(
            ...
            children: [
              Row(
                children: [
                  const Text('Score  ' ,style: TextStyle(color: headerColor,fontSize: 20 , fontWeight: FontWeight.bold), ),
                  ElevatedButton(
                      onPressed: null,
                      style: ButtonStyle(
                      ...
                      child: Text('${GameController().scoreGame}' ,style: const TextStyle(color: backgroundColor,fontSize: 20 , fontWeight: FontWeight.bold), ),
                  )
                ],
              ),
